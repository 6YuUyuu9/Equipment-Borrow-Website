...
<html lang="en">
  ...
  <body background="bg_img/Equipment Borrow Website (17).png">
	  <br>
...
<div class="container-fluid">
	...
	<div class="col-sm-3">
		...
		<a href="?page=equipment" class="btn btn-light" style="width: 100%">จัดการอุปกรณ์</a><br><br>
		<a href="?page=user" class="btn btn-light" style="width: 100%">สมาชิก</a><br><br>
			...
			if(isset($_GET['page'])){
				switch($_GET['page']){
					case "borrow" : include("page/borrow.php");break;
						...
						case "equipment" : include("page/equipment.php");break;
						case "user" : include("page/user.php");break;
